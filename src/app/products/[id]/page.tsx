    ...
    <div className="bg-background pb-24">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div className="flex justify-center gap-2 mb-6">
            <Button variant="outline" className="rounded-full bg-accent hover:bg-border text-sm">
        ...
        <p className="text-muted-foreground mb-6">
            Un anillo atemporal que simboliza el amor eterno. Hecho a mano con diamantes de origen ético y metales preciosos.
        </p>
        ...
        <Accordion type="single" collapsible className="w-full mb-8">
            <AccordionItem value="item-1">
                ...
                <AccordionContent>
                Oro de 18k, diamantes de origen ético. Limpiar suavemente con un paño suave.
                </AccordionContent>
            </AccordionItem>
        ...
        <p className="text-center text-red-500 font-bold mb-8">¡Solo quedan 5 en stock!</p>
            ...
            <div className="space-y-6">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-sm">Precioso anillo, superó mis expectativas.</p>
                    </div>
                </div>
                <div className="flex items-start gap-4">
                     <Avatar>
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-sm">Buen anillo, pero el tamaño es un poco grande.</p>
                    </div>
                </div>
            </div>
        </div>
