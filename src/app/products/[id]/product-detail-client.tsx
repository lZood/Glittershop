...
const METALS = [
  { id: 'oro-amarillo', name: 'Oro Amarillo', color: '#E6C200' },
  { id: 'oro-blanco', name: 'Oro Blanco', color: '#E1E1E1' },
  { id: 'oro-rosa', name: 'Oro Rosa', color: '#B76E79' },
];
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="font-semibold text-sm uppercase tracking-wide text-muted-foreground">Metal</span>
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="description">
                ...
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  {product.description}
                  <br /><br />
                  Un diseño que combina la elegancia clásica con un toque moderno, perfecto para elevar cualquier look.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="materials">
                <AccordionTrigger className="text-base font-semibold">Materiales y Cuidados</AccordionTrigger>
                <AccordionContent className="text-muted-foreground leading-relaxed">
                  Oro de 18k certificado y gemas de origen ético. Recomendamos limpiar con un paño suave y evitar el contacto directo con perfumes.
                </AccordionContent>
              </AccordionItem>
            ...
            <div className="flex-1 relative flex items-center justify-center p-0 md:p-12 overflow-hidden">
              <AnimatePresence initial={false} custom={direction}>
                <motion.div
                  ...
                  dragElastic={1}
                  onDragEnd={(e, { offset, velocity }) => {
                    // Only allow swipe if not zoomed in (this is a simplification, ideally we check scale)
                    const swipe = swipePower(offset.x, velocity.x);
                    if (swipe < -swipeConfidenceThreshold) {
                      paginate(1);
                    } else if (swipe > swipeConfidenceThreshold) {
